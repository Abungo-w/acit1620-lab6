...
const url = ["https://i.ibb.co/sjvVrG3/fruit-plyh.jpg", "https://i.ibb.co/g3tqj4w/fruit-zxcv.jpg", "https://i.ibb.co/88Hy4rD/fruit-wert.jpg",
...
let randomUrl = shuffle(url);

let images = document.querySelectorAll(".card img");

for (var i = 0; i < randomUrl.length; i++) {
    images[i].src = randomUrl[i];
}
